...
from visier_user_management_python_sdk.pydantic.user_groups_users_for_tenant_dto import UserGroupsUsersForTenantDTO
...
class UserGroupsUsersDTO(BaseModel):
    ...
    tenants: typing.Optional[typing.List[UserGroupsUsersForTenantDTO]] = Field(None, alias='tenants')
