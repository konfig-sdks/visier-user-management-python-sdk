...
class RequiredUsersAPISuccessDTO(TypedDict):
    pass

class OptionalUsersAPISuccessDTO(TypedDict, total=False):
...
class UsersAPISuccessDTO(RequiredUsersAPISuccessDTO, OptionalUsersAPISuccessDTO):
    pass
