...
class RequiredUsersUpdateAPIUserDTO(TypedDict):
    pass

class OptionalUsersUpdateAPIUserDTO(TypedDict, total=False):
...
class UsersUpdateAPIUserDTO(RequiredUsersUpdateAPIUserDTO, OptionalUsersUpdateAPIUserDTO):
    pass
