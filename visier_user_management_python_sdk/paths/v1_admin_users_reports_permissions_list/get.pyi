...
class BaseApi(api_client.Api):
    ...
    def _get_all_permissions_xlsx_mapped_args(
        self,
    ...
    async def _aget_all_permissions_xlsx_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/admin/users/reports/permissions-list',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_all_permissions_xlsx_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetAllPermissionsXlsxRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_permissions_xlsx(
        self,
        tenant_code: typing.Optional[str] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_all_permissions_xlsx_mapped_args(
            tenant_code=tenant_code,
        )
        return await self._aget_all_permissions_xlsx_oapg(
    ...
    def get_all_permissions_xlsx(
        ...
        return self._get_all_permissions_xlsx_oapg(
            query_params=args.query,
        )

class GetAllPermissionsXlsx(BaseApi):
    ...
    async def aget_all_permissions_xlsx(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_all_permissions_xlsx(
            tenant_code=tenant_code,
            **kwargs,
        )
        if validate:
    ...
    def get_all_permissions_xlsx(
        ...
        raw_response = self.raw.get_all_permissions_xlsx(
            tenant_code=tenant_code,
        )
        if validate:
            return RootModel[typing.IO](raw_response.body).root
