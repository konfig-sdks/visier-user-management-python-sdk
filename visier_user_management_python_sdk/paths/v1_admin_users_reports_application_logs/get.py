...
class BaseApi(api_client.Api):
    ...
    def _get_application_logs_xlsx_mapped_args(
        self,
    ...
    async def _aget_application_logs_xlsx_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/admin/users/reports/application-logs',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_application_logs_xlsx_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetApplicationLogsXlsxRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_application_logs_xlsx(
        self,
        start_time: typing.Optional[str] = None,
        end_time: typing.Optional[str] = None,
        tenant_code: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_application_logs_xlsx_mapped_args(
            start_time=start_time,
            end_time=end_time,
            tenant_code=tenant_code,
        )
        return await self._aget_application_logs_xlsx_oapg(
    ...
    def get_application_logs_xlsx(
        ...
        return self._get_application_logs_xlsx_oapg(
            query_params=args.query,
        )

class GetApplicationLogsXlsx(BaseApi):
    ...
    async def aget_application_logs_xlsx(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_application_logs_xlsx(
            start_time=start_time,
            end_time=end_time,
            tenant_code=tenant_code,
            **kwargs,
    ...
    def get_application_logs_xlsx(
        ...
        raw_response = self.raw.get_application_logs_xlsx(
            start_time=start_time,
            end_time=end_time,
            tenant_code=tenant_code,
        )
