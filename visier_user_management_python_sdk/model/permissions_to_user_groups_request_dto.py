...
class PermissionsToUserGroupsRequestDTO(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class userGroups(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['PermissionsToUserGroupRequestDTO']:
                        return PermissionsToUserGroupRequestDTO
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['PermissionsToUserGroupRequestDTO'], typing.List['PermissionsToUserGroupRequestDTO']],
                ...
                def __getitem__(self, i: int) -> 'PermissionsToUserGroupRequestDTO':
