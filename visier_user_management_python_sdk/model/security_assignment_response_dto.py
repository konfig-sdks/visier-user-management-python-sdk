...
class SecurityAssignmentResponseDTO(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class tenants(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TenantAssignmentsDTO']:
                        return TenantAssignmentsDTO
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['TenantAssignmentsDTO'], typing.List['TenantAssignmentsDTO']],
                ...
                def __getitem__(self, i: int) -> 'TenantAssignmentsDTO':
