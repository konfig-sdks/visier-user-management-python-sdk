...
class UserCreationAPIResponseDTO(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["userId", "username", "displayName", "employeeId", "accountEnabled", "email", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["userId", "username", "displayName", "employeeId", "accountEnabled", "email", ], str]):
