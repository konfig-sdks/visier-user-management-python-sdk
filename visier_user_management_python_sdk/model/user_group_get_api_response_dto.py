...
class UserGroupGetAPIResponseDTO(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class permissions(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['PermissionResponseDTO']:
                        return PermissionResponseDTO
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['PermissionResponseDTO'], typing.List['PermissionResponseDTO']],
                ...
                def __getitem__(self, i: int) -> 'PermissionResponseDTO':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["userGroupId", "displayName", "permissions", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["userGroupId", "displayName", "permissions", ], str]):
