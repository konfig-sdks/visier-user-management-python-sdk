...
class UserUpdateAPIRequestDTO(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["displayName", "employeeId", "accountEnabled", "email", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["displayName", "employeeId", "accountEnabled", "email", ], str]):
