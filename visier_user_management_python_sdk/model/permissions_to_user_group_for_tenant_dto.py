...
class PermissionsToUserGroupForTenantDTO(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["tenantCode", "status", "message", "userGroups", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["tenantCode", "status", "message", "userGroups", ], str]):
